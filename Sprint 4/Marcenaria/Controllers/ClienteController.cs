...
namespace Marcenaria.Controllers
{
    public class ClienteController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ClienteId,ClienteNome,ClienteTel,ClienteEmail")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ClienteId,ClienteNome,ClienteTel,ClienteEmail")] Cliente cliente)
        {
