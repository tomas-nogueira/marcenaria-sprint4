...
namespace Marcenaria.Controllers
{
    public class VendaHasProdutoController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["VendaId"] = new SelectList(_context.Venda, "VendaId", "VendaNome");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,VendaId,ProdutoId")] VendaHasProduto vendaHasProduto)
        {
            ...
            ViewData["ProdutoId"] = new SelectList(_context.Produto, "ProdutoId", "ProdutoNome", vendaHasProduto.ProdutoId);
            ViewData["VendaId"] = new SelectList(_context.Venda, "VendaId", "VendaNome", vendaHasProduto.VendaId);
            return View(vendaHasProduto);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,VendaId,ProdutoId")] VendaHasProduto vendaHasProduto)
        {
